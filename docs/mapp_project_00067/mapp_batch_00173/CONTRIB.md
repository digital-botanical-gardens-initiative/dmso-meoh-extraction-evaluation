...
```bash
sg commons-users -c './copy_files.sh -i /media/share/mapp/public/QE_HFX_unifr/converted -o /msdata/mapp_project_00067/mapp_batch_00173 -p "*20250506_CVOL*.mzML"'
```

### Transfer the metadata to the msdata folder

```bash
cd ./docs/mapp_project_00067/mapp_batch_00173/
cp ./metadata/treated/mapp_batch_00173_metadata.tsv /msdata/mapp_project_00067/mapp_batch_00173/
```
...
```bash
cd ./docs/mapp_project_00067/mapp_batch_00173/results/mzmine
```

And proceed to awk black magic to update the mzmine xml file

```bash
awk -v dir="/msdata/mapp_project_00067/mapp_batch_00173" '
BEGIN {
  cmd = "ls " dir "/*.mzML"
...
}' mapp_batch_00173.mzbatch_template > mapp_batch_00173.mzbatch
```
...
```bash
sg commons-users -c '/opt/mzmine/bin/mzmine -batch mapp_batch_00173.mzbatch'
```
...
```bash
taxonomical-utils resolve-taxa --input-file docs/mapp_project_00067/mapp_batch_00173/metadata/original/mapp_batch_00173_metadata.tsv --output-file docs/mapp_project_00067/mapp_batch_00173/metadata/original/mapp_batch_00173_metadata_resolved.csv --org-column-header source_taxon
```

2. retrieve upper taxa lineage
    
```bash
taxonomical-utils append-taxonomy --input-file docs/mapp_project_00067/mapp_batch_00173/metadata/original/mapp_batch_00173_metadata_resolved.csv --output-file docs/mapp_project_00067/mapp_batch_00173/metadata/original/metadata_upper_taxa_lineage.csv
```

3. append WD ids 

```bash
taxonomical-utils append-wd-id --input-file docs/mapp_project_00067/mapp_batch_00173/metadata/original/mapp_batch_00173_metadata_resolved.csv --output-file docs/mapp_project_00067/mapp_batch_00173/metadata/original/mapp_batch_00173_wd.csv
```

```bash
taxonomical-utils merge --input-file docs/mapp_project_00067/mapp_batch_00173/metadata/original/mapp_batch_00173_metadata.tsv --resolved-taxa-file docs/mapp_project_00067/mapp_batch_00173/metadata/original/mapp_batch_00173_metadata_resolved.csv --upper-taxa-lineage-file docs/mapp_project_00067/mapp_batch_00173/metadata/original/metadata_upper_taxa_lineage.csv --wd-file docs/mapp_project_00067/mapp_batch_00173/metadata/original/mapp_batch_00173_wd.csv --output-file docs/mapp_project_00067/mapp_batch_00173/metadata/treated/mapp_batch_00173_metadata.tsv --org-column-header source_taxon
```
...
ssh commons-server
tmux a -t sirius
cd ~/git_repos/mapp-metabolomics-unit/dmso-meoh-extraction-evaluation/docs/mapp_project_00067/mapp_batch_00173/results
```
...
paths:
  ...
  input_folder: /home/allardpm/git_repos/mapp-metabolomics/dmso-meoh-extraction-evaluation/docs/mapp_project_00067/mapp_batch_00173/results/met_annot_enhancer # The path were you want your GNPS job folder to be placed
  project_name: mapp_batch_00173 #ISDB_annot_LP_plantfungi_set # The name you want to give to your project, output resulst in data_out/project_name
  output_folder: /home/allardpm/git_repos/mapp-metabolomics/dmso-meoh-extraction-evaluation/docs/mapp_project_00067/mapp_batch_00173/results/met_annot_enhancer # the path for your output to be stored in
...
```
```bash
python /home/allardpm/git_repos/mapp-metabolomics/mandelbrot_project/met_annot_enhancer/src/dev/nb.py
```
...
```yaml
paths:
  docs: '/home/allardpm/git_repos/mapp-metabolomics/dmso-meoh-extraction-evaluation/docs'
  output: '/home/allardpm/git_repos/mapp-metabolomics/dmso-meoh-extraction-evaluation/docs/mapp_project_00067/mapp_batch_00173/results/stats' # Not mandatory, default is in the stats subdirectory
...
mapp_batch : mapp_batch_00173
met_annot_enhancer_folder : mapp_batch_00173
gnps_job_id : 

dataset_experiment : 
  name: "mapp_batch_00173 LCMS metabolomics dataset"
  description: "Untargeted metabolomics of 6 DBGI species comparing DMSO versus MEOH extractions"
...
``````bash
Rscript /home/allardpm/git_repos/mapp-metabolomics/biostat_toolbox/src/biostat_toolbox.r
```
...
```bash
met-annot-unifier-cli align-horizontally --canopus-file ./results/sirius/canopus_structure_summary.tsv --gnps-file ./results/met_annot_enhancer//nf_output/library/merged_results_with_gnps.tsv --gnps-mn-file ./results/met_annot_enhancer//nf_output/networking/clustersummary_with_network.tsv --sirius-file ./results/sirius/structure_identifications.tsv --isdb-file ./results/met_annot_enhancer/mapp_batch_00173/mapp_batch_00173_spectral_match_results_repond_flat.tsv --output ./results/tmp/mapp_batch_00173_met_annot_unified_horizontal.tsv
```

#### Align vertically

```bash
met-annot-unifier-cli align-vertically  --gnps-file ./results/met_annot_enhancer//nf_output/library/merged_results_with_gnps.tsv --isdb-file ./results/met_annot_enhancer/mapp_batch_00173/mapp_batch_00173_spectral_match_results_repond_flat.tsv --sirius-file ./results/sirius/structure_identifications.tsv  --output ./results/tmp/mapp_batch_00173_met_annot_unified_vertical.tsv
```